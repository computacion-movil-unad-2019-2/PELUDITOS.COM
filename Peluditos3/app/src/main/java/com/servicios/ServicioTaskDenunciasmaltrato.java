...
public class ServicioTaskDenunciasmaltrato extends AsyncTask<Void, Void, String> {
    ...
    public CDenunciamaltrato denunciamaltrato = new CDenunciamaltrato();

    // constructor del hilo (AsyncTask)

    public ServicioTaskDenunciasmaltrato(Context ctx, String linkAPI, CDenunciamaltrato obj){
        this.httpContext=ctx;
        this.linkrequestAPI=linkAPI;
        this.denunciamaltrato = obj;
    }
    ...
    protected String doInBackground(Void... params) {
        ...
        try{
            ...
            parametrosPost.put("descripcion",this.denunciamaltrato.getDescripcion().toString());
