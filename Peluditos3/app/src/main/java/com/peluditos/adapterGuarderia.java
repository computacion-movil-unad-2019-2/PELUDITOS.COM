...
public class adapterGuarderia extends BaseAdapter {

    private Context context;
    private ArrayList<guarderia> arrayList;

    public adapterGuarderia(Context context, ArrayList<guarderia> arrayList){
