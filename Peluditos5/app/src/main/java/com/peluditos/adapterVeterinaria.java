...
public class adapterVeterinaria extends BaseAdapter{

    private Context context;
    private ArrayList<veterinaria> arrayList;

    public adapterVeterinaria(Context context, ArrayList<veterinaria> arrayList){
