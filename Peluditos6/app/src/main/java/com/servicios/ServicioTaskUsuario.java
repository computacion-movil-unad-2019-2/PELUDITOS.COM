...
public class ServicioTaskUsuario extends AsyncTask<Void, Void, String> {
    ...
    public CUsuario usuario = new CUsuario();

    // constructor del hilo (AsyncTask)

    public ServicioTaskUsuario(Context ctx, String linkAPI, CUsuario obj){
    ...
    protected String doInBackground(Void... params) {
        ...
        try{
            ...
            parametrosPost.put("user",this.usuario.getUser().toString());
            parametrosPost.put("nombres",this.usuario.getNombres().toString());
            parametrosPost.put("pwd",this.usuario.getPwd().toString());
            parametrosPost.put("documento",this.usuario.getDocumento().toString());
